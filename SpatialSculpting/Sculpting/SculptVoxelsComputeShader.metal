...
void sculpt(texture3d<float, access::read> voxelsIn [[texture(0)]],
            ...
            uint3 localCoords [[thread_position_in_grid]]) {

    // Offset local thread coords to actual voxel coords (localized dispatch).
    uint3 voxelCoords = localCoords + sculptParams.regionOffset;
